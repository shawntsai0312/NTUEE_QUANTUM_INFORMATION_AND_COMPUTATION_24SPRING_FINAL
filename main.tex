...
\label{introduction}
\input{sections/1_introduction/1.tex}

\section{Review of the surface code}
\label{review}
\input{sections/2_review_surface_code/2.tex}

\section{Decoder}
\label{decoder}
\input{sections/3_decoder/3.tex}

\section{Stabilizer}
\label{stabilizer}
\input{sections/4_stabilizer/4.tex}

\section{Practical implementation of the surface code}
\label{algorithm}
\input{sections/5_practical_implementation/5.tex}
